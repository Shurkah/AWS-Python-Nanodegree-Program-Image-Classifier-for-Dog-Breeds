...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # Creates dognames set for quick matching to results_dic labels from
    # real answer & classifier's answer.
    # I chose set rather than dictionary or list,
    # because sets are the fastest for checking if an item is in or not.
    dognames = set()
    ...
    with open(dogfile, "r") as infile:
        ...
        # Adds dogname to the set if it isn't already there
        while line != "":
            line = line.strip()
    ...
    for key in results_dic:
        ...
        # Pet Image Label IS NOT a Dog image
            ...
            # only Classifier label is a dog
            if results_dic[key][1] in dognames:
                results_dic[key].extend((0, 1))

            # both labels aren't dogs
            else:
