...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][2] == 1:
            ...
            # Breed is identified correctly when:
            # the pet image label and the classifier label match (condition above)
            # AND the pet image label indicates the image is-a-dog (condition below)
    ...
    # Calculate run statistics (counts & percentages) using the counters from above.

  
    # Calculate % of correct matches
